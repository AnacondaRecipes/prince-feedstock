...
Feedstock license: [BSD-3-Clause](https://github.com/AnacondaRecipes/prince/blob/main/LICENSE.txt)
...
Updating prince-feedstock
========================

If you would like to improve the prince recipe or build a new
